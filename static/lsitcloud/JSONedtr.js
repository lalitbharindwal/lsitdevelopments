function JSONedtr( data, outputElement, config = {} ){
	...
	JSONedtr.addRowForm = function( plus ) {
		...
		$( plus ).html('<input type="text" placeholder="Enter Key" class="jse--key" data-level="' + lvl + '" value=""> : <span class="jse--typeof">( ' + typeofHTML + ' )</span> <input type="text" class="jse--value jse--value__new" placeholder="Enter Value" value=""> <button class="jse--save btn ripple btn-primary" style="padding: 5px; font-size: 10px">Save</button> <button class="jse--cancel btn ripple btn-light" style="padding: 5px; font-size: 10px">Cancel</button>');
